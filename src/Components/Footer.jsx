...
function Footer() {
  return (
    <footer className='footer p-10 bg-base-200 text-neutral'>
      <aside>
        <div>
          <span className='text-4xl font-extrabold'>Thanks For Visiting!</span>
          <br />
          ...
          <a
            ...
            target='_blank'
            className='btn bg-primary text-base-100 rounded-xl drop-shadow-2xl border-none hover:bg-base-100 hover:text-primary lg:mt-4 text-2xl'
            rel='noreferrer'
          >
            Contact
          </a>
      ...
      <nav>
        <header className='footer-title text-primary'>Social</header>
        <div className='grid grid-flow-col gap-4'>
          ...
          >
            <svg
              ...
              width='30'
              height='30'
              className='fill-neutral hover:fill-primary animate-pulse hover:scale-150 hover:animate-none transition-transform'
            >
      ...
      <nav>
        <header className='footer-title text-primary'>Navigation</header>
        <div className='grid grid-flow-row gap-4 text-lg font-semibold ml-4 '>
          <Link
