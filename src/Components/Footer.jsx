    ...
    <footer className="footer mt-4 bg-base-300/65 p-6 sm:p-8 md:p-10 lg:px-36  backdrop-blur-sm text-neutral">
      <aside>
        <div>
          ...
          <div className="mt-4 sm:mt-6 text-xs sm:text-sm md:text-base lg:text-lg">
          ...
          <a
            ...
            target="_blank"
            className="btn mt-2 sm:mt-5 lg:mt-4 bg-primary text-base-100 rounded-xl drop-shadow-2xl border-none hover:bg-base-100 hover:text-primary text-sm  sm:text-lg lg:text-2xl"
            rel="noreferrer"
          >
            Contact
          </a>
        ...
        <div className="grid grid-flow-col gap-2 sm:gap-4">
          ...
          >
            <svg
              ...
              viewBox="0 0 448 512"
              className="fill-neutral w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 hover:fill-primary animate-pulse hover:scale-125 lg:hover:scale-150 hover:animate-none transition-transform"
            >
      ...
      <nav className="opacity-80 w-full lg:justify-center mt-6 lg:mt-0">
        ...
        <div className="grid grid-flow-row gap-2 sm:gap-4 ml-2 sm:ml-4 text-xs sm:text-sm md:text-base lg:text-lg font-semibold">
          <Link
            className="hover:text-primary hover:scale-110 lg:hover:scale-150 transition"
            to="/"
          >
            Home
          </Link>
