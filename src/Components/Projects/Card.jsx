    ...
    <div className="card bg-transparent backdrop-blur-sm border-b border-primary shadow-sm shadow-primary w-full sm:w-fit rounded-lg">
      <div className="group relative w-full sm:w-96 rounded-t-lg overflow-hidden">
        ...
        {img && !imageError ? (
          ...
          //   className="w-full lg:min-h-64 h-44 hover:scale-110 object-cover rounded-t-lg group-hover:scale-110 transition-all duration-500 ease-in-out will-change-transform"
          //   loading={loading}
          ...
          // Direct fallback when no image src or error
          <div className="w-full lg:min-h-64 h-44 bg-gradient-to-br from-gray-200 to-gray-300 rounded-t-lg flex items-center justify-center">
            <div className="text-center">
              <svg 
                className="w-12 h-12 mx-auto mb-2 text-gray-400" 
                fill="none" 
              ...
              <span className="text-gray-500 text-sm">
                {!img ? "No image provided" : "Image failed to load"}
              </span>
            </div>
          </div>
        )}
